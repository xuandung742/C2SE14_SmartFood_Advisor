...
import { MdBrandingWatermark, MdLineWeight, MdOutlineBrandingWatermark, MdOutlineRateReview } from "react-icons/md";
                        ...
                        <div className='col-md-7'>
                            <div className=" pt-3 pb-3 pl-4 pr-4">
                                ...
                                <div className="productInfo mt-4">
                                    ...
                                    <div className="row">
                                        <div className="col-sm-3 d-flex align-items-center">
                                            <span className="icon"><MdOutlineRateReview /></span>
                                                        ...
                                                        <div className="col-sm-7 d-flex">
                                                            <div className="d-flex flex-column">
                                                                <div className="userInfo d-flex align-items-center mb-3">
                                                                    <UserAvatarImgComponent img="https://static-00.iconduck.com/assets.00/user-icon-2046x2048-9pwm22pp.png" lg={true} />
